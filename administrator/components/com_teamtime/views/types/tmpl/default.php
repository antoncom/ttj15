	...
	<table>
		<tr>
			<td align="left" width="100%">
				...
				<button onclick="document.getElementById('search').value='';this.form.getElementById('from_period').value='';this.form.getElementById('until_period').value='';this.form.submit();"><?php echo JText::_('Reset'); ?></button>
				<p>
