...
class TeamtimebpmViewProcesses extends JView {
	...
	public function display($tpl = null) {
		...
		JHTML::script('process-list.js', URL_MEDIA_COMPONENT_ASSETS . "js/teamtimebpm/");
		...
		// set toolbar items
		JToolBarHelper::title(TEAMLOG_TOOLBAR_TITLE . JText::_('Processes'), TEAMLOG_ICON);
		...
		$this->assignRef('mProcess', $mProcess);
