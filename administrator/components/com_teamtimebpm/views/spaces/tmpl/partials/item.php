	...
	<div class="expandablePanel">
		<div class="flowTable">
			...
			<? foreach ($items as $item) { ?>
				...
				<div class="itemSummary" style="width: 33%; "
						 data-id="<?= $item->id ?>"
						 data-archived="<?= $item->archived ?>"
						 data-hasProcesses="<?= $this->mSpace->hasTemplatesOrProcesses($item->id) ?>">
					<div class="hoverArea">
						<img src="/<?= URL_MEDIA_COMPONENT_ASSETS ?>images/space_26x26.gif" class="gwt-Image icon" title="Space">
						<div class="body">
							...
							<?=
							$this->mSpace->isFollowed($item->id) ?
