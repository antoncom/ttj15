...
class TeamtimebpmViewTemplates extends JView {
	...
	public function display($tpl = null) {
		...
		// get request vars		
		JHTML::script('template-list.js', URL_MEDIA_COMPONENT_ASSETS . "js/teamtimebpm/");
		...
		// set toolbar items
		JToolBarHelper::title(TEAMLOG_TOOLBAR_TITLE . JText::_('Templates'), TEAMLOG_ICON);
		...
		$filter_archived = $mainframe->getUserStateFromRequest(
				$option . $name . '.filter_archived', 'filter_archived', 'active', 'string');
		$options = array();
		...
		if ($filter_order == "a.tags" || $filter_order == "a.space_id") {
		...
		$this->assignRef('mTemplate', $mTemplate);
