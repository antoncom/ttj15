 ...
 * @version     $Id: sef_ext.php 855 2009-01-02 21:46:48Z silianacom-svn $
 */
...
class sef_404
{
  ...
  {
    global $sefConfig, $shMosConfig_locale;
    // get DB
    $database =& JFactory::getDBO();
    $title = array();
  ...
  {
    GLOBAL $sefConfig, $shMosConfig_locale, $option, $shHomeLink;
    // get DB
    $database =& JFactory::getDBO();
