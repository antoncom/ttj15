		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="right" style="padding-right:10px">
				<?=TeamTime::_("Calendar_getLink",
					...
					"project_id={$row->id}&view_type=".$view_type.$filter_date)?>
			</td>
			...
			<td align="center">
				<?php
					echo JHTML::_('teamlog.projectstatelist', array(), "state".$row->id, 'class="inputbox" onchange="submitStateChange(\'setState\', '.$row->id.');"', 'value', 'text', $row->state);
				?>
			</td>
