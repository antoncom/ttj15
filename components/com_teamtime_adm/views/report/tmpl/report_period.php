...
JHTML::script('FusionCharts.js', 'administrator/components/com_teamtime/libraries/fusioncharts/charts/');
      ...
      <tbody>
        ...
        foreach ($this->report['data'] as $project) {
          ...
          <tr class="<?php echo "row$k"; ?>">
            ...
            <td align="right">
              <?=
              TeamTime::_("Calendar_getLink", round($project['splan'], 2), "project_id={$project['id']}&view_type=" . $view_type . $filter_date)
              ?>
            </td>

            <td align="right">
              <?php echo DateHelper::formatTimespan($project['duration'], 'h:m'); ?>
            </td>
            ...
            <td align="center">
              <?= (int) $project['scosts'] ?> / <?= (float) round($project['smoney'], 2) ?>
            </td>
          </tr>
          <?php
          $k = 1 - $k;
      ...
      <tfoot>
        <tr>
          <td colspan="2" style="font-weight:bold;text-align:right;">
            <?php echo DateHelper::formatTimespan($this->report['total_plan'], 'hr mi'); ?>
          </td>
          ...
          <td style="font-weight:bold;text-align:center;">
            <?= (int) $this->report['total_costs'] ?> / <?= (float) round($this->report['total_money'], 2) ?>
          </td>
        </tr>
      </tfoot>
    </table>
