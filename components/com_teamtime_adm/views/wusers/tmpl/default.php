      ...
      <thead>
        <tr>
          ...
          <th  class="title" width="100%">
            <?php echo JHTML::_('grid.sort', JText::_('User'), 'a.name', @$this->lists['order_Dir'], @$this->lists['order']); ?>
          </th>
          ...
          <tr class="<?php echo "row$k"; ?>">
            ...
            <td>
              <span class="editlinktip hasTip" title="<?php echo JText::_('Edit User'); ?>::<?php echo $row->name; ?>">
                <a href="index.php?option=com_teamtime&controller=wuser&task=edit&cid[]=<?= $row->id ?>"><?php echo $row->name; ?></a>
              </span>
            </td>
            ...
            <td align="right" style="padding-right:10px">
              <?=
              TeamTime::_("Calendar_getLink", round((float) $row->splan, 2), "user_id={$row->id}&view_type=" . $view_type . $filter_date)
              ?>
            </td>
