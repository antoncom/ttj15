...
window.Raphael.svg && function (R) {
    ...
    ElementR.prototype = elproto;
    elproto.constructor = ElementR;

    R._engine.path = function (pathString, SVG) {
        var el = $("path");
        SVG.canvas && SVG.canvas.appendChild(el);
        var p = new ElementR(el, SVG);
        p.type = "path";
        setFillAndStroke(p, {
            fill: "none",
            stroke: "#000",
