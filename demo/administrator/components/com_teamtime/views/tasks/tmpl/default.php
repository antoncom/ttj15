...
<form action="index.php" method="post" name="adminForm">
  ...
  <div id="tablecell">
    <table class="adminlist">
      <thead>
        <tr>
          ...
          <th  class="title">
						<?php
						echo JHTML::_('grid.sort', 'Type', 'type_name', @$this->lists['order_Dir'],
								@$this->lists['order']);
						?>
          </th>
          <th  class="title">
					...
					if ($this->lists['select_target'] != "") {
						...
						<th  class="title">
						<?php
						echo JHTML::_('grid.sort', 'Vector of goal', 'tv.title', @$this->lists['order_Dir'],
								@$this->lists['order']);
						?>
						</th>
						<? } ?>
          ...
          <th width="1%" nowrap="nowrap">
					...
					?>
						...
						<th width="1%" nowrap="nowrap">
	<?php
	echo JHTML::_('grid.sort', 'Rate', 'a.rate', @$this->lists['order_Dir'], @$this->lists['order']);
	?>
						</th>
						<? } ?>
        </tr>
	...
	<? if ($this->lists['select_target'] != "") { ?>
						...
						<td align="center">
	<?php
	echo JHTML::_('teamtime.taskstatelist', array(), "state" . $row->id,
