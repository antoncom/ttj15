    ...
    var loadPrice = function(target_id) {
      ...
      function (data) {
		...
		if ($("#project_id").val() != "") {
			...
			$.get(TeamTime.baseUrl +
				"index.php?option=com_teamtime&controller=task&task=loadtasks&project_id="+
				$("#project_id").val()+
			...
			$.get(TeamTime.baseUrl +
				"index.php?option=com_teamtime&controller=todo&task=get_list_todos&project_id=" +
				$("#project_id").val() +
        ...
        <fieldset class="adminform">
          ...
          <table class="admintable">
            ...
            <tr>
              ...
              <td>
								<?php
								echo ($this->item->hours_fact > 0) ? $this->item->hours_fact : "0"
								?>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="checkbox" name="is_parent" id="is_parent"
								<?=
								(int) $this->item->is_parent ? "checked" : "disabled"
								?> value="1">
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" name="sendmail" value="1">
						...
						<?
						$helperFormals->getTodoNotifyClient($this->item, "")
						?>

						<?
						TeamTime::helper()->getFormals()->getTodoParams($this->item, "standart")
						?>
        ...
        <fieldset class="adminform">
          ...
          <table class="admintable">
            ...
            <tr>
              <td valign="top" colspan="3">
								<div class="main-editor"
										 ...
										 data-current-id="<?= $this->item->id ?>">
											 <?=
											 $editor->display('description', $this->item->description, '550px', '300px', '60', '20');
											 ?>
								</div>
              </td>
            </tr>
            ...
            <tr>
              <td>
								<?
								TeamTime::helper()->getBase()->getTodoRepeatParams2($this->item, "")
								?>
              </td>
            </tr>
...
<script>
  ...
  function submitbutton(pressbutton) {
    ...
    if($("#user_id").val() != "" && (pressbutton == "save" || pressbutton == "apply")){
      $.get(TeamTime.baseUrl +
				"index.php?option=com_teamtime&controller=todo&task=check_project_for_user"+
        "&project_id="+$("#project_id").val()+
        "&user_id="+$("#user_id").val(),
      function(data){
        ...
        if(enable_project){
          $.get(TeamTime.baseUrl +
						"index.php?option=com_teamtime&controller=todo&task=enable_project_for_user"+
            "&project_id="+$("#project_id").val()+
            "&user_id="+$("#user_id").val(),
          function(data){
