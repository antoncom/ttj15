...
class DoctypeController extends JController {
	/*
	...
	function save() {
		...
		if ($this->checkPost($post)) {
			if ($model->store($post)) {
				$msg = JText::_('Doctype Saved');
			}
			else {
				$msg = JText::_('Error Saving Doctype');
			}
		}
