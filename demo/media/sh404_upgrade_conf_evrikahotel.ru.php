...
// saved at: 2009-10-11 21:07:04
// by: admin (id: 62 )
// domain: http://evrikahotel.ru
...
$defaultComponentStringList = array("contact"=>"","content"=>"","gk2_tabs_manager"=>"","gk3_photoslide"=>"","gk3_tabs_manager"=>"","hsconfig"=>"","jce"=>"","newsfeeds"=>"","phocagallery"=>"","phocaguestbook"=>"","poll"=>"","search"=>"","user"=>"","weblinks"=>"","wrapper"=>"");
