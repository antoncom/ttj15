...
if($_POST['action']=='sendform'){
	...
	if(!preg_match("/^([a-z0-9_]|\-|\.)+@(([a-z0-9_]|\-)+\.)+[a-z]{2,4}$/", $email)) $ERROR_DATA['email'] = "Неправильный Емайл";
	...
	if($number_of_guests=="0") $ERROR_DATA['number_of_guests'] = "Вы идиот. Укажите цифрой Количество гостей";
...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4" align="center"><img src="/modules/mod_yj_booking/newfiles/sp.gif" alt="Спасибо" width="124" height="30" vspace="30" /></td>
  </tr>
  <tr>
    <td align="right" valign="top"><img src="/modules/mod_yj_booking/newfiles/sp2.gif" width="139" height="172" hspace="25" /></td>
    ...
    <td valign="top" class="tt">Спасибо! Ваша заявка направлена в службу бронирования гостиницы &#8220;Эврика&#8221; в г. Йошкар-Ола <br />
        <br />
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#a2a2a2">
          <tr>
            <td class="tdh">Тип номера </td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;<? echo $destination_pack ?></td>
          </tr>
          <tr>
            <td class="tdh">Количество гостей </td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;<? echo $number_of_guests ?></td>
          </tr>
          <tr>
            <td class="tdh">Даты</td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;с <? echo $day_of_arrival." ".$month_of_arrival." ".$year_of_arrival ?> по <? echo $day_of_departure." ".$month_of_departure." ".$year_of_departure ?></td>
          </tr>
          <tr>
            <td class="tdh">Контактное лицо </td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;<? echo $first_name ?></td>
          </tr>
          <tr>
            <td class="tdh">Емайл</td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;<? echo $email ?></td>
          </tr>
          <tr>
            <td class="tdh">Телефон</td>
            <td class="tdt">&nbsp;&nbsp;&nbsp;<? echo $phone ?></td>
          </tr>
        </table>
      <br />
      В ближайшее время мы свяжемся с Вами для подтверждения брони. Желаем удачи! </td>
  </tr>
  <tr>
    <td colspan="4" align="center"><br />
        <br />
        <a href="#" class="cl" onclick="return hs.close(this)">ВЫХОД</a><br /></td>
  </tr>
</table>
