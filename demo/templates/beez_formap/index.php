...
*/ ?>
		...
		<div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
			<a name="mainmenu"></a>
			<div id="left">
			<h1 id="logo" style="height:233px; width: 280px;">
...
<td valign="top"><img src="/images/elka.gif" width="110" height="47" alt=""><center>
  <a href="http://www.evrikahotel.ru"><img src="/images/logo.gif" width="210" height="114" alt="Эврика" border="0" style="margin-top:5px;"></a>
</center><div id="logoAddress">424031, Республика Марий Эл, г. Йошкар-Ола, ул. Чехова, д.73, Тел: 8 (8362) 46-90-83, 46-90-74, <img src="/images/email_sm.gif" alt="Email" /></div></td></tr></table>
			</h1>
			<noindex>
		...
		<div id="footer">
			<p class="syndicate">&nbsp;&nbsp;&nbsp;<a href="/exlinks.html">Обмен ссылками</a>
