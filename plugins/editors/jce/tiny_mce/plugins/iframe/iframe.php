<?php
/**
* @version iframe.php 2009-03-21 Ryan Demmer
* @package JCE
			...
			return new IFrame({
				...
				params: {
					defaults : {	
						...
						'marginwidth': 	'<?php echo $params->get( 'iframe_marginwidth', '' );?>',
						'marginheight': '<?php echo $params->get( 'iframe_marginheight', '' );?>'
					}
				}
			});
		}
		...
		<div class="panel_wrapper">
			...
			<fieldset>
					...
					<table cellpadding="3" cellspacing="0" border="0" style="height:175px;">
                        ...
                        <tr>
                            <td><label for="allowtransparency" class="hastip" title="<?php echo JText::_('ALLOWTRANSPARENCY DESC');?>"><?php echo JText::_('ALLOWTRANSPARENCY');?></label></td>
                            <td colspan="2">
